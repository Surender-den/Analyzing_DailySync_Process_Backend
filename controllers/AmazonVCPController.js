    ...
    try{
        ...
        query_timeout: 20000,            // 20 seconds
          ...
          if (orgChannels.length === 0) {
            console.log('No valid orgIds found for AmazonVCP.');
            return;
          }
        ...
        //   });
          ...
          orgChannels.forEach(({ org_id, channel }) => {
            ...
            if (status === 'COMPLETED'||'PROFIT TRIGGER') {
              ...
              if (
                completedReports.some(report => report.report_type === 'Profitability-AmazonVCP') &&
                completedReports.some(report => report.report_type === 'AmazonVCP') 
